...
async function startQuiz(userDetails) {
    ...
    try {
        ...
        console.error('שגיאה בטעינת החידון:', error);
        showModal({
            title: 'שגיאה בטעינת החידון',
            message: 'אירעה שגיאה בטעינת החידון. אנא נסה שוב.',
            icon: 'error'
        });
    }
}
...
async function submitQuiz() {
    ...
    if (userAnswers.includes(null)) {
        showModal({
            title: 'אזהרה',
            message: 'יש שאלות שלא ענית עליהן. האם אתה בטוח שברצונך להגיש את החידון?',
            icon: 'warning',
            confirmText: 'כן, הגש חידון',
            cancelText: 'לא, חזור לחידון',
            onConfirm: async () => {
...
async function submitQuizToServer() {
    ...
    try {
        ...
        showModal({
            title: 'שגיאה בהגשת החידון',
            message: error.message || 'אירעה שגיאה בהגשת החידון. אנא נסה שוב.',
            icon: 'error'
        });
    } finally {
        hideLoading();
