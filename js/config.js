const CONFIG = {
    ...
    quiz: {
        ...
        nextQuizDate: '2025-05-19',  // תאריך החידון הבא
        hebrewDate: "יום שני",  // תאריך עברי
        displayDate: "19.5",  // תאריך לתצוגה
        showAnnouncement: true,  // האם להציג הודעה לפני החידון
        announcementText: "ברוכים הבאים לחידון \nמידי שבוע נערוך חידון על הגדות חז''ל הנלמדות באותו שבוע, תתקיים הגרלה על פרסים יקרי ערך מבין המשתתפים\n בהצלחה מרובה!",
